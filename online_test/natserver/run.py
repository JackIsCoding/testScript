...
def check_tel():
    ...
    #tel_list = ['t16b17','t16b15','t16b16','t05b089','t05b090','t05b091','t33e017','t33e018','t33e020','t30c020','t30c026','t30c038']
    #tel_list = ['t16b16', 't16b17', 't05b089', 't05b090', 't05b091', 't33e017', 't33e018', 't33e020', 't30c020', 't30c026', 't30c038', 'tw03a101', 'tw03a102', 'tw03a103', 't33e021s1', 't33e021s2', 't33e021s3', 't33e021s4']
    #tel_list = ['t33e021s1','t33e021s2','t33e021s3','t33e021s4','tw03a101','tw03a102','tw03a103']
    #tel_list = ['t16b15']
    for tel_item in tel_list:
        ...
        print 'host num is:',i,'\n'
        time.sleep(1)
        #for port in [3076,53,4004,1755,5004,4000,8000]:
        for port in [53]:
                print '---------------------------------------------------------------------------------------------------------\n'
