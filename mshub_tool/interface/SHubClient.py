...
class Resp:
    ...
    def write_conf(self, ar, cf, section):
		...
		#print 'section',section,'item',item ,'value',val_list[1]
            elif val_list[0] == 'list':
            ...
            if item == "has_record" and self.cmdid_ == 5002 and val_list[1] == "0":
                download = ar.readI32()                       #for user-defined type, we need to read the len
                print 'download_stragy:',download
                break;
...
if __name__ == "__main__":
    ...
    try:
        options, args = getopt.getopt(sys.argv[1:], "f:h:p:u:c:g:s:b:i:e:z:", ["file","host=", "port=", "url=", "cid=", "gcid=", "bt=", "index=", "emule=", "filesize="])
    except getopt.GetoptError, err:
        print "opt error: %s"%(err)
        sys.exit()

    query_file = ""
    host = "http://10.10.67.101:80"
    #host = "http://10.10.159.53:80"
    #host = "http://m07a012.sandai.net"
    #host = "http://10.10.32.142:80"
    #host = "http://t33e025s4.sandai.net:80"
    #host = "http://c1213.sandai.net:80"
