...
Query server res with rsa encode
	[Documentation]		query server res with rsa encode
	Case_init          ${resources_path}/queryserverres.query          ${resources_path}/queryserverres.resp
    Set_res_info       ${thunder_gcid}    ${thunder_cid}    ${thunder_filesize}
    Rsa_send_query
    Check

Query server res with zlib encode
    [Documentation]     query server res with zlib encode
    Case_init          ${resources_path}/queryserverres.query          ${resources_path}/queryserverres.resp
    Set_res_info       ${thunder_gcid}    ${thunder_cid}    ${thunder_filesize}
    Zlib_send_query
    Check
