...
Query bcid info, no bcid info
	...
	Set_gcid_filesize  1111111111111111111111111111111111111111    1234567890
	Set_expect         1111111111111111111111111111111111111111    ${EMPTY}
	Send_query
	Check
...
Query_bcid with rsa encode
	[Documentation]		query_bcid with rsa encode
	Case_init          ${resources_path}/querybcid.query          ${resources_path}/querybcid.resp
	Set_gcid_filesize  ${thunder_gcid}    ${thunder_filesize}
	Set_expect         ${thunder_gcid}    ${thunder_bcid}
	Rsa_send_query
...
Query_bcid with zlib encode
    [Documentation]     query_bcid with zlib encode
    Case_init          ${resources_path}/querybcid.query          ${resources_path}/querybcid.resp
    Set_gcid_filesize  ${thunder_gcid}    ${thunder_filesize}
    Set_expect         ${thunder_gcid}    ${thunder_bcid}
    Zlib_send_query
