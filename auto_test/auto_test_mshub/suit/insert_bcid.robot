...
Insert bcid info,whose cid length is less than 40
	...
	Delete_bcid_info             ${thunder_gcid}
	Del_dc_bcid_info             ${thunder_gcid}
	Del_cn_bcid_info             ${thunder_gcid}
	Send_insert
	Sleep                        1
	Check_bcid_key               ${thunder_gcid}    0
	Check
...
Insert bcid info,whose gcid length is more than 40
	...
	Send_insert
	Sleep                        1
	Check_bcid_key               55555555555555555555555555555555555555555555555555    0
	Check
...
Insert bcid info,whose sha1(bcid) is not equal gcid
	...
	Send_insert
	Sleep                        1
	Check_bcid_key               1111111111111111111111111111111111111111    0
	Check
