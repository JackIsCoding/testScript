...
*** Test Cases ***
Query res_info with third-party filter
	[Documentation]    query url hits filter condition.
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
	Set_query_original_url     ${FILTER_URL}    http://original_url.flv
	Set_bywhat         0
	Send_query
	Check_filter
...
Query res_info by query_url,res_info is not exist
	...
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
	Set_query_url      http://test_result.notexist/query_url/res_info.rar
	Set_bywhat         0
...
Query res_info by original_url,res_info is not exist
	...
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
	Set_original_url   http://test_result.notexist/original_url/res_info.rar
	Set_bywhat         0
	Set_expect         ${EMPTY}    ${EMPTY}    0    ${EMPTY}
	Send_query
	Check_all
...
Query res_info with rsa encode
	[Documentation]		query res info with rsa encode
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
    Set_query_url      ${thunder_url}
    Set_bywhat         0
    Set_expect         ${thunder_gcid}    ${thunder_cid}    ${thunder_filesize}    ${thunder_bcid}
...
Query res_info with zlib encode
    [Documentation]     query res info with zlib encode
    Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
    Set_query_url      ${thunder_url}
    Set_bywhat         0
    Set_expect         ${thunder_gcid}    ${thunder_cid}    ${thunder_filesize}    ${thunder_bcid}
...
Query res_info with filesuffix is midownload
	[Documentation]  query res_info with filesuffix is midownload
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
	Set_query_url      ${midownload_url}
	Set_bywhat          0
	Set_expectsuffix   ${midownload_gcid}    ${midownload_cid}   ${midownload_filesize}     ${EMPTY}
	Send_query
	Check_suffix

Query res_info by session url
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
	Set_query_url       ${session_url}
	Set_bywhat          0
	Set_expect          ${session_gcid}     ${session_cid}      ${session_filesize}      ${session_bcid}
	Send_query
	Check_all
...
Query res_info by query_url small sp
	...
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
    Set_query_url      ftp://10.10.8.105/1234567890123456789012345678901234567890/thunder7/Thunder_dl.rmvb
...
Query res_info by original_url from old shub
	...
	Send_query
	Check_all
Query res_info through anti-rob, with query url and original url
    [Documentation]    With query_url and original_url
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
    Set_original_url   ${thunder_url}
	Set_query_url      ${thunder_url}  
	Set_bywhat         0
...
Query res_info through anti-rob
    [Documentation]    With query_url and empty original_url
	Case_init          ${resources_path}/queryresinfo_url.query          ${resources_path}/queryresinfo_url.resp
    Set_original_url   ${EMPTY}
	Set_query_url      ${http_url}  
	Set_bywhat         0
	Set_query_option   2
	Set_expect         ${http_gcid}    ${http_cid}    ${http_filesize}    ${http_bcid}
	Send_query
	Check_all
############ invalid params ##############
...
#	Set_query_original_url     ${FILTER_URL}    http://original_url.flv
#	Set_bywhat         0
#	Set_expect         ${EMPTY}    ${EMPTY}    0    ${EMPTY}     15
#	Send_query
#	Check_all
