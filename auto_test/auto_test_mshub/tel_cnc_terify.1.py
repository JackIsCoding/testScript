...
tel_read_list = ['http://t33e025s1.sandai.net']
tel_write_list = ['http://t1628.sandai.net','http://t16115.sandai.net','http://t33e033.sandai.net','http://t33e032.sandai.net']
cnc_read_list = ['http://c1213.sandai.net']
...
def run(type):
    ...
    if type == 'cnc':
        for i in range(4):
            config2 = ConfigObj(cnc_conf)
            config2['read_interface']['host']=cnc_read_list[0]
            config2['write_interface']['host']=cnc_write_list[i%4]
            config2.write()
            print 'ngx_read_ip',config2['read_interface']                                                                                                              
            print 'ngx_write_ip',config2['write_interface']
