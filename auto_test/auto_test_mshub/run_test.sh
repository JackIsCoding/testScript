...
ROOT_PATH='/usr/local/sandai/test_tools/mshub_tool/auto_test_mshub/'
...
function main()
{
        ...
        'insert_res_1')
            $COMMAND -N 'Mshub Auto Test Insert_res' ${ROOT_PATH}suit/insert_res_1.robot ;;
        'insert_res')
        ...
        'mshub_mob')
           cat resources/config_mob.data > resources/config.data
           sleep 1
