...
class InsertBtRes(object):
	def insert_bt_case_init(self,insert_file,resp_file):
	...
	def set_bt_res(self,infoid,newinfoid,index,filesize,cid,gcid,bcid):
		self._request['globalsection']['infoid'] = 'string_hex:' + str(infoid)
		self._request['globalsection']['index'] = 'uint32:' + str(index)
		self._request['globalsection']['new_info_id'] = 'string_hex:' + str(newinfoid)
