...
from rsa_tool_account import RSATool
...
class SHubClient(object):
    ...
    def start_with_rsa(self, req):
        try:
            ...
            return decrypto_buff
           # resp_agent = Resp(None)
            #return resp_agent.decode(decrypto_buff, False, resp), 200
        except urllib2.HTTPError as e:
            return None, e.getcode()
        except EOFError as e:
            return None, 200
    ...
    def start_with_zlib(self, req, resp):
        try:
            ...
            resp_agent = Resp(None)
            return resp_agent.decode_with_zlib(decrypto_buff, False, resp), 200
        except urllib2.HTTPError as e:
            return None, e.getcode()
        except EOFError as e:
            return None, 200
