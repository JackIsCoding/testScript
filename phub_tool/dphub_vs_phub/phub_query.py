...
def send_ping():
    ...
    for i in range(1,100):
        ...
        #client = pHubClient.PHubClient('10.10.33.201',3076,query_file,resp_file)
...
def send_report():
    ...
    for i in range(1,100):
        ...
        #client = dphub_client.PHubClient('10.10.33.201',80,query_file,resp_file)
        res = client.start()

def send_peer_query():
    #query_file = ConfigObj('peer_query.query')
    #resp_file = ConfigObj('peer_query.resp')
    query_file = ConfigObj('peer_query_v66.query')
    resp_file = ConfigObj('peer_query_v66.resp')
