...
class Dphub_peer(object):
    ...
    def make_query_owner_pack(self):
        self._owner_query_conf['globalsection']['PeerID'] = 'string:7845C4084DE3ED1U'.strip()
    
    def make_query_peer_pack(self, gcid, cid, filesize):
        self._peer_query_conf['globalsection']['PeerID'] = 'string:7845C4084DE3ED1U'
    ...
    def make_query_rcnode_pack(self, gcid, cid, filesize):
        self._rcnode_query_conf['globalsection']['PeerID'] = 'string:7845C4084DE3ED1U'
...
class Phub_peer(object):
    def init(self,host,port):
        self._host = host
        self._port = port
        self._query_conf = ConfigObj('peer_query_v66.query')
        self._resp_conf = ConfigObj('peer_query_v66.resp')
        
    def make_query_pack(self,gcid,cid,filesize):
        self._query_conf['globalsection']['peerid'] = 'string:7845C4084DE3ED1U'.strip()
